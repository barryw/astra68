...
#define ASTRA_ROM_ADDRESS             0xffe00000u
...
#define ASTRA_KERNEL_STATUS_SHUTDOWN 0x4b53444eu /* "KSDN" */
#define ASTRA_KERNEL_STATUS_RESTART  0x4b525354u /* "KRST" */
