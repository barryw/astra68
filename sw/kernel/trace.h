...
#define KERNEL_TRACE_CAPACITY \
    ((KERNEL_TRACE_STORAGE_SIZE - KERNEL_TRACE_HEADER_SIZE) / \
     KERNEL_TRACE_RECORD_SIZE)
...
typedef enum KernelTraceEvent {
    ...
    KERNEL_TRACE_EVENT_PROCESS_EXIT,
    KERNEL_TRACE_EVENT_SYSTEM_DEGRADED,
    KERNEL_TRACE_EVENT_COUNT
} KernelTraceEvent;

/* Argument 0 for KERNEL_TRACE_EVENT_SYSTEM_DEGRADED. */
typedef enum KernelTraceDegradedReason {
    KERNEL_TRACE_DEGRADED_INITIAL_IMAGE_MISSING = 1,
    KERNEL_TRACE_DEGRADED_INITIAL_IMAGE_REJECTED,
    KERNEL_TRACE_DEGRADED_INITIAL_IMAGE_EXITED,
    KERNEL_TRACE_DEGRADED_HOST_BLOCK_MISSING,
    KERNEL_TRACE_DEGRADED_HOST_LINK_TIMEOUT,
    KERNEL_TRACE_DEGRADED_HOST_INPUT_MISSING
} KernelTraceDegradedReason;
