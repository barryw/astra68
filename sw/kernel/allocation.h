...
typedef enum KernelAllocationSite {
    ...
    KERNEL_ALLOCATION_SITE_THREAD_TLS_PAGE = 29,
    KERNEL_ALLOCATION_SITE_LIBRARY_METADATA = 30,
    KERNEL_ALLOCATION_SITE_THREAD_KERNEL_STACK = 31,
    KERNEL_ALLOCATION_SITE_PROCESS_HANDLE_TABLE = 32,
    KERNEL_ALLOCATION_SITE_THREAD_WAIT_REGISTRATIONS = 33,
    KERNEL_ALLOCATION_SITE_DMA_METADATA = 34,
    KERNEL_ALLOCATION_SITE_AREA_MAPPING_METADATA = 35,
    KERNEL_ALLOCATION_SITE_DEVICE_METADATA = 36,
    KERNEL_ALLOCATION_SITE_PORT_METADATA = 37,
    KERNEL_ALLOCATION_SITE_PORT_MESSAGE_METADATA = 38,
    KERNEL_ALLOCATION_SITE_DETACHED_HANDLE_METADATA = 39,
    KERNEL_ALLOCATION_SITE_RING_METADATA = 40,
    KERNEL_ALLOCATION_SITE_SYNC_METADATA = 41,
    KERNEL_ALLOCATION_SITE_ELF_METADATA = 42,
    KERNEL_ALLOCATION_SITE_AREA_OBJECT_METADATA = 43,
    KERNEL_ALLOCATION_SITE_AREA_PAGE_METADATA = 44,
    KERNEL_ALLOCATION_SITE_COUNT = 45
