...
if [[ "$reuse_sim" != "1" || ! -x obj_dir_boot_sdram/Vtb_boot_sdram ]]; then
    ...
    verilator --binary -j 0 --Mdir obj_dir_boot_sdram \
        ...
        ../astra_soc.sv ../astra_front_panel.sv ../boot_memory_map.sv ../tg68k_cache_store.sv ../astraea_blitter.sv ../uart_tx.sv ../uart_rx.sv ../uart_rx_fifo.sv ../spi_sd.sv \
        ../astra_host_async_byte_fifo.sv ../astra_host_spi_slave.sv ../astra_host_boot.sv \
