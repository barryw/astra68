...
platform paths and the interpreter entry-point name are supplied by the
userspace Lua library and command builds. The native wrapper remains outside
this tree, so upgrading Lua is a clean replacement rather than a source merge.
