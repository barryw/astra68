...
#(
    parameter int VIDEO_RATE_HZ = 25200000,
...
localparam [63:0] CYCLE_TIME_STAMP_COUNTER_IDEAL = (64'(VIDEO_RATE_HZ) * 64'(N)) / 128 / AUDIO_RATE;
localparam int CYCLE_TIME_STAMP_COUNTER_WIDTH = $clog2((CYCLE_TIME_STAMP_COUNTER_IDEAL * 64'd11 + 64'd9) / 64'd10); // Account for 10% deviation in audio clock
