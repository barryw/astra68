...
|---|---:|---:|---:|
| TRELLIS_COMB | 54,345 (64.98%) | 29,295 | 21 |
...
If P45 is retained, the complete-chipset envelope permits at most 8,385
additional packed logic sites. Its 21-cell current-profile margin is a gate
...
| Measured-growth contingency at P45 | 885 |

These are admission limits, not estimates to spend. An 885-cell contingency is
