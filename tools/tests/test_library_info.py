...
def record(name="graphics.library.1", major=1, minor=0, patch=0,
           ...
           flags=0, exports_offset=0):
    blob = struct.pack(library_info._HEAD, magic, record_version, size,
                       major, minor, patch, abi_major, abi_minor, flags,
                       target, 0x10203040, exports_offset)
