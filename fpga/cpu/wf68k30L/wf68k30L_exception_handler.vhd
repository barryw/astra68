...
begin
    ...
    IRQ_FILTER : process
    -- Two-stage synchronizer for the incoming IRQ level. Was negative-edge; now positive-edge
    -- so the whole core is single-edge. Still a 2-FF synchronizer (IPLn is static in the
    -- Astra 68 SoC anyway). Avoids spurious IRQs from IRQ_IN in a different clock domain.
