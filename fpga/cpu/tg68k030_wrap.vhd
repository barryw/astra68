-- Astra 68 - common-interface wrapper for apolkosnik/TG68K.C 030_mmu.
--
...
architecture rtl of tg68k_wrap is
    ...
    signal dbg_berr_pending    : std_logic;
...
begin
    ...
    RWn <= not walker_we_latched when bus_active = '1' and walker_cycle = '1' else
           tg_nwr;
    RMCn <= '1' when bus_active = '1' and walker_cycle = '1' else tg_rmcn;
    ...
    u_cpu : entity work.TG68KdotC_Kernel
        ...
        port map(
            ...
            debug_berr_pending => dbg_berr_pending,
