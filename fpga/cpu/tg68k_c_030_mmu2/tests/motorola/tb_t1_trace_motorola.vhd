...
entity tb_t1_trace_motorola is
end entity;

architecture behavior of tb_t1_trace_motorola is
...
begin
    ...
    begin
        ...
        report "=== Test 11: reserved SR/CCR bits read as zero in trace frame ===" severity note;
        init_common;
        setup_stop_handler;
        mem(16#1000# / 2) := x"46FC";
        ...
        if mem_read(16#07F4#) = x"A000" then
            report "PASS: Test 11 - Stacked SR clears unused SR/CCR bits" severity note;
            pass_count := pass_count + 1;
        else
            report "FAIL: Test 11 - Stacked SR retained unused SR/CCR bits" severity error;
            fail_count := fail_count + 1;
        end if;
